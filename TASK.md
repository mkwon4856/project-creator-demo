# Project Creator — rebuild Task 5
## 게임사 대시보드 재개발

경로: src/app/studio/page.tsx
디자인: 다크 #0A0A0F / 우베 #9B7EC8 / 골드 #E5B567 / Arial Black

---

## Task 5-1: 게임사 대시보드 page.tsx 전면 교체

src/app/studio/page.tsx 를 아래 내용으로 완전 교체:
...
1. git add . && git commit -m "rebuild: studio dashboard" && git push origin rebuild
2. PROGRESS.md 업데이트
